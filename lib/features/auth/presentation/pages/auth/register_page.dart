            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // Submit Button + BLoC Listener
                  BlocConsumer<AuthBloc, AuthState>(
                    listener: (context, state) {
                      // CRUCIAL: State handling
                      if (state is RegistrationComplete) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(l10n.registrationSuccess ?? "Account created! Please log in."),
                        ...
                        onPressed: state is AuthLoading
                            ...
                            : () {
                                if (_formKey.currentState!.validate()) {
                                  // CRUCIAL FIX: Ensure 'unassigned' role is passed here
                                  context
                                      .read<AuthBloc>()
                                      .add(RegisterSubmitted(
                                        ...
                                        role: 'unassigned', // Mandatory default role
                                      ));
                                }
                              },
